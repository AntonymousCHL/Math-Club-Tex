...
% Text Node
\draw (316.2,265.57) node [anchor=north west][inner sep=0.75pt]    {$x$};
% Text Node
...
% Text Node
\draw (269.31,308.33) node [anchor=north west][inner sep=0.75pt]    {$180^\circ +\angle A$};
% Text Node
...
%Shape: Triangle [id:dp23293589440504348] 
\draw   (277,35.8) -- (381.8,216.2) -- (144.8,216.2) -- cycle ;
%Straight Lines [id:da01681368413005635] 
\draw    (277,35.8) -- (277.8,216.2) ;
%Straight Lines [id:da2761783098095556] 
\draw    (228.2,103) -- (381.8,216.2) ;
%Straight Lines [id:da4994741922568293] 
\draw    (322.2,114.2) -- (144.8,216.2) ;
%Shape: Circle [id:dp8341671878060917] 
\draw   (89.4,119.6) .. controls (89.4,57.41) and (139.81,7) .. (202,7) .. controls (264.19,7) and (314.6,57.41) .. (314.6,119.6) .. controls (314.6,181.79) and (264.19,232.2) .. (202,232.2) .. controls (139.81,232.2) and (89.4,181.79) .. (89.4,119.6) -- cycle ;

% Text Node
\draw (102.8,75.4) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\footnotesize Shares same chord}};
% Text Node
\draw (213.2,121) node [anchor=north west][inner sep=0.75pt]   [align=left] { };
% Text Node
\draw (260,153) node [anchor=north west][inner sep=0.75pt]    {$H$};
% Text Node
\draw (276.8,17.8) node [anchor=north west][inner sep=0.75pt]    {$A$};
% Text Node
\draw (132.4,219) node [anchor=north west][inner sep=0.75pt]    {$B$};
% Text Node
\draw (379.6,218.2) node [anchor=north west][inner sep=0.75pt]    {$C$};
% Connection
\draw    (173.04,96.4) -- (208.58,122.16) ;
\draw [shift={(210.2,123.34)}, rotate = 215.94] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
