...
\subsubsection{Definition: A line that intersects a circle at only one point.}
\vspace{20px}
...
Since $AO=BO$, OC is shared, and $\angle OAC=\angle OBC$ (SSA), $AC=BC$ (Hypotenuse Length Theorem).
\end{minipage}
