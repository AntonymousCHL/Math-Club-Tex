...
%Shape: Circle [id:dp7743386354543087] 
\draw   (272,153.77) .. controls (272,93.14) and (321.14,44) .. (381.77,44) .. controls (442.39,44) and (491.53,93.14) .. (491.53,153.77) .. controls (491.53,214.39) and (442.39,263.53) .. (381.77,263.53) .. controls (321.14,263.53) and (272,214.39) .. (272,153.77) -- cycle ;
%Straight Lines [id:da47145245486689236] 
\draw    (23.53,197.03) -- (639.53,194.03) ;
%Straight Lines [id:da7467273744841061] 
\draw    (332.53,4.03) -- (279.53,193.03) ;
%Straight Lines [id:da8376954192631836] 
\draw    (313.53,66.03) -- (482.53,193.03) ;
%Straight Lines [id:da08661975676931188] 
\draw    (313.53,66.03) -- (186.53,195.03) ;
%Straight Lines [id:da05307429520515172] 
\draw    (23.53,197.03) -- (444.53,9.03) ;

% Text Node
\draw (297.53,49.03) node [anchor=north west][inner sep=0.75pt]   [align=left] {A};
% Text Node
\draw (267,195) node [anchor=north west][inner sep=0.75pt]   [align=left] {B};
% Text Node
\draw (484.53,196.03) node [anchor=north west][inner sep=0.75pt]   [align=left] {C};
% Text Node
\draw (361,50) node [anchor=north west][inner sep=0.75pt]   [align=left] {E};
% Text Node
\draw (188.53,198.03) node [anchor=north west][inner sep=0.75pt]   [align=left] {F};
% Text Node
\draw (25.53,200.03) node [anchor=north west][inner sep=0.75pt]   [align=left] {G};
% Text Node
\draw (334.53,7.03) node [anchor=north west][inner sep=0.75pt]   [align=left] {D};


\end{tikzpicture}
Since $AE$ is the external angle bisector \\
$\angle GAB=\angle DAE = \angle EAC$\\
Also by Tangent-Chord Theorem, $\angle FAB = \angle ACB$ \\
Therefore, $\angle G = \angle EAC - \angle ACB = \angle GAB - \angle FAB = \angle GAF$\\
Therefore, AFG is an isosceles triangle
